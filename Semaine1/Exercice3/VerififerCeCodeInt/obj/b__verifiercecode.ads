...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_verifiercecode" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#aaf754e0#;
   pragma Export (C, u00001, "verifiercecodeB");
   ...
   u00137 : constant Version_32 := 16#6b8fe9b8#;
   pragma Export (C, u00137, "codeutilsB");
   u00138 : constant Version_32 := 16#8014567d#;
   pragma Export (C, u00138, "codeutilsS");
